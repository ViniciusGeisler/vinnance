package com.vinannce.controller.user;

import com.vinannce.usecases.dto.user.UserDTO;
import com.vinannce.usecases.dto.user.UserRequestDTO;
import com.vinannce.entity.user.UserEntity;
import com.vinannce.repository.user.UserRepository;
...
public class UserController {
    ...
    public ResponseEntity<Void> create(@RequestBody UserRequestDTO data) {
